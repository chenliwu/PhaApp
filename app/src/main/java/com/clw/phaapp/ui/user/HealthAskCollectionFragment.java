 ...
 * 健康问答收藏列表
 */
public class HealthAskCollectionFragment extends
        BaseMvpFragmentV4<UserCollectionContract.IGetAskCollectionView, GetAskCollectionListPresenter>
        implements UserCollectionContract.IGetAskCollectionView, OnRefreshListener, OnLoadMoreListener {

    private static HealthAskCollectionFragment FRAGMENT1;
    ...
    private AskCollectionAdapter mAdapter;
     ...
     * @return
     */
    public static HealthAskCollectionFragment getInstance() {
        if (FRAGMENT1 == null) {
            FRAGMENT1 = new HealthAskCollectionFragment();
        }
        return FRAGMENT1;
    }
    ...
    private void initRecyclerview() {
        ...
        //创建并设置Adapter
        mAdapter = new AskCollectionAdapter(mCollectionList,mDataList,this,mContext);
        //设置item的点击事件
        mAdapter.setItemClickListener(new AskCollectionAdapter.MyItemClickListener() {
            @Override
        ...
        //设置长按事件
        mAdapter.setOnItemLongClickListener(new AskCollectionAdapter.MyItemLongClickListener() {
            @Override
     ...
     */
    @Override
    protected GetAskCollectionListPresenter initPresenter() {
        return new GetAskCollectionListPresenter();
    }
    ...
    public void refreshDataSuccess(UserCollectionEntity userCollectionEntity) {
        ...
        if(collectionList!=null && collectionList.size()>0){
            ...
            mDataList.addAll(userCollectionEntity.getAsklist());
     ...
     */
    @Override
    public void getAskCollectionCollectionFail(String msg) {
        dismissLoading();
        showShortToast(msg);
    }
