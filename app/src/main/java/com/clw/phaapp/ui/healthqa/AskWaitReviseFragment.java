...
import com.clw.phaapp.adapter.AskWaitReviseAdapter;
 ...
 * 健康问答,待修改
 */
public class AskWaitReviseFragment extends BaseMvpFragmentV4<AskContract.IGetAskListView, GetAskListPresenter>
		implements View.OnClickListener, AskContract.IGetAskListView,
		OnRefreshListener, OnLoadMoreListener {

	private static AskWaitReviseFragment INSTANCE;
	...
	private AskWaitReviseAdapter mAdapter;
	/**
	 * 记录当前页数
	 */
	int currentPage = 0;
	 ...
	 * @return
	 */
	public static AskWaitReviseFragment getInstance() {
		if (null == INSTANCE) {
			INSTANCE = new AskWaitReviseFragment();
		}
		return INSTANCE;
	}
	...
	private void initRecyclerview() {
		...
		//创建并设置Adapter
		mAdapter = new AskWaitReviseAdapter(mDataList,this,mContext);
		//设置item的点击事件
		mAdapter.setItemClickListener(new AskWaitReviseAdapter.MyItemClickListener() {
			@Override
		...
		//设置长按事件
		mAdapter.setOnItemLongClickListener(new AskWaitReviseAdapter.MyItemLongClickListener() {
			@Override
