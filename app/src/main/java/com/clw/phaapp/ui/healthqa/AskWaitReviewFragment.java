...
import com.clw.phaapp.adapter.AskWaitReviewAdapter;
 ...
 * 健康问答,等待审核
 */
public class AskWaitReviewFragment extends BaseMvpFragmentV4<AskContract.IGetAskListView, GetAskListPresenter>
        implements View.OnClickListener, AskContract.IGetAskListView,
        OnRefreshListener, OnLoadMoreListener {

    private static AskWaitReviewFragment INSTANCE;
    ...
    private AskWaitReviewAdapter mAdapter;
    /**
     * 记录当前页数
     */
    int currentPage = 0;
    ...
    private RelativeLayout common_view_no_data;
     ...
     * @return
     */
    public static AskWaitReviewFragment getInstance() {
        if (null == INSTANCE) {
            INSTANCE = new AskWaitReviewFragment();
        }
        return INSTANCE;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mBaseView = inflater.inflate(R.layout.fragment_ask_wait_review, container, false);
        initFragment();
        initView();
        //初始化用户信息
    ...
    protected void initView() {
        ...
        common_view_no_data = (RelativeLayout) mBaseView.findViewById(R.id.common_view_no_data);
        data_view = (LinearLayout) mBaseView.findViewById(R.id.data_view);
    }
    ...
    private void initRecyclerview() {
        ...
        //创建并设置Adapter
        mAdapter = new AskWaitReviewAdapter(mDataList, this, mContext);
        //设置item的点击事件
        mAdapter.setItemClickListener(new AskWaitReviewAdapter.MyItemClickListener() {
            @Override
        ...
        //设置长按事件
        mAdapter.setOnItemLongClickListener(new AskWaitReviewAdapter.MyItemLongClickListener() {
            @Override
...
//            common_view_no_data.setVisibility(View.GONE);
//        }else{
//            data_view.setVisibility(View.GONE);
//            common_view_no_data.setVisibility(View.VISIBLE);
//        }
