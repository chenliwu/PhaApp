...
/**
 * 易源数据，健康资讯，综合资讯Fragment类
 *
 * @author chenliwu
 * @create 2018-03-14 21:24
 **/
public class GlobalHealthInfoFragment extends BaseMvpFragmentV4<HealthInfoContract.IGetHealthInfoListView, GetHealthInfoListPresenter>
        implements HealthInfoContract.IGetHealthInfoListView,OnRefreshListener, OnLoadMoreListener {

    private final static String TAG = "GlobalHealthInfoFragment";

    private static GlobalHealthInfoFragment FRAGMENT1;
     ...
     * @return
     */
    public static GlobalHealthInfoFragment getInstance() {
        if (FRAGMENT1 == null) {
            FRAGMENT1 = new GlobalHealthInfoFragment();
        }
        return FRAGMENT1;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBaseView = inflater.inflate(R.layout.fragment_global_health_info, container, false);
        initFragment();
        initView();
        initRecyclerview();
        return mBaseView;
