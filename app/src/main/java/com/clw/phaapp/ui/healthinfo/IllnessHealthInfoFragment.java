...
/**
 * 易源数据，健康资讯，疾病资讯Fragment类
 * tid = 2
 *
 * @author chenliwu
 * @create 2018-03-14 21:24
 **/
public class IllnessHealthInfoFragment extends BaseMvpFragmentV4<HealthInfoContract.IGetHealthInfoListView, GetHealthInfoListPresenter>
        implements HealthInfoContract.IGetHealthInfoListView,OnRefreshListener, OnLoadMoreListener {

    private final static String TAG = "IllnessHealthInfoFragment";

    private static IllnessHealthInfoFragment FRAGMENT1;
     ...
     * @return
     */
    public static IllnessHealthInfoFragment getInstance() {
        if (FRAGMENT1 == null) {
            FRAGMENT1 = new IllnessHealthInfoFragment();
        }
        return FRAGMENT1;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBaseView = inflater.inflate(R.layout.fragment_illness_health_info, container, false);
        initFragment();
        initView();
        initRecyclerview();
        return mBaseView;
