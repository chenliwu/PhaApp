 ...
 **/
public class RevisePwdUserPresenter extends BaseUserPresenter<UserContract.IRevisePwdView>
        implements  UserContract.IRevisePwdPresenter{
     ...
     */
    @Override
    public void revisePwd(final UserEntity userEntity) {
        ...
        new android.os.Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                mRxManager.register(mUserModel.revisePwd(userEntity).subscribe(new Consumer<ResultEntity>() {
                    //接受数据成功，选择视图显示数据
                    @Override
