 ...
 * 待审核,健康问答列表的适配器
 */
public class AskWaitReviewAdapter extends RecyclerView.Adapter<AskWaitReviewAdapter.MyViewHolder > {
    ...
    public AskWaitReviewAdapter(List<AskEntity> mAskEntityList, BaseMvpFragmentV4 mBaseMvpFragmentV4, Context context) {
