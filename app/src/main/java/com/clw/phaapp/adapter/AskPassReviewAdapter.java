 ...
 * 已通过审核,健康问答列表的适配器
 */
public class AskPassReviewAdapter extends RecyclerView.Adapter<AskPassReviewAdapter.MyViewHolder > {
    ...
    public AskPassReviewAdapter(List<AskEntity> mAskEntityList,BaseMvpFragmentV4 mBaseMvpFragmentV4,Context context) {
    ...
    public MyViewHolder  onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).
                inflate(R.layout.item_management_ask_pass_review_list,viewGroup,false);
    ...
    public void onBindViewHolder(MyViewHolder  viewHolder, int position) {
        ...
        //显示回答总数
        viewHolder.txt_showAllAnswerCount.setText("回答总数："+askEntity.getAllanswercount());

        //显示采纳回答的个数
        viewHolder.txt_showAcceptAnswerCount.setText("采纳个数："+askEntity.getAcceptanswercount());

        //显示未采纳个数
        viewHolder.txt_showUnAcceptAnswerCount.setText("未采纳个数："
                +(askEntity.getAllanswercount()-askEntity.getAcceptanswercount()));
    ...
    public static class MyViewHolder  extends RecyclerView.ViewHolder
         ...
         * 显示回答总数
         */
        public TextView txt_showAllAnswerCount;
        /**
         * 显示已采纳回答总数
         */
        public TextView txt_showAcceptAnswerCount;
        /**
         * 显示未采纳回答总数
         */
        public TextView txt_showUnAcceptAnswerCount;
        /**
         * 显示问题状态
         */
        ...
        public MyViewHolder (View view,MyItemClickListener myItemClickListener,
            ...
            txt_showAllAnswerCount =  view.findViewById(R.id.txt_showAllAnswerCount);
            txt_showAcceptAnswerCount =  view.findViewById(R.id.txt_showAcceptAnswerCount);
            txt_showUnAcceptAnswerCount =  view.findViewById(R.id.txt_showUnAcceptAnswerCount);
